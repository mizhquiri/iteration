...
1.define your input (see above, l)
...
will give you a simpliied vector of what you were starting out with
 - each time you are getting a dataframe, you could bind rows 
 
 
 you could also define map(list_norm, median) -- > output also works 
 
 using dbl and df would help you show #s and bind rows respectively
```{r}
...
- you could do map_df as well instead of map below
